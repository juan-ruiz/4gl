...
.footer {
  ...
  background-color: #000000;
	...
	<body>
		<a href="#edit-PF_Multimedia" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-PF_Multimedia" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${PF_MultimediaInstance?.version}" />
				<fieldset class="form">
